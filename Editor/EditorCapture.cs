...
public class EditorCapture : EditorWindow
{
    ...
    private static Vector2Int GetGameViewSize()
    {
        ...
        System.Reflection.MethodInfo getSizeOfMainGameView = gameViewType.GetMethod(
            "GetSizeOfMainGameView",
            System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static
        );
        object resolution = getSizeOfMainGameView.Invoke(null, null);
        return Vector2Int.RoundToInt((Vector2)resolution);
    }

    public void Capture(string fullPath)
    {
        Vector2Int resolution = GetGameViewSize();
        ...
        Debug.Log("Saved capture to: " + fullPath);
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("Capture Game View", GUILayout.Height(50)))
        {
            ...
            Capture(path + lastCapturedImageName);
